...
<?php 
include("dbcon.php");
$sel="SELECT * FROM orders WHERE status='pending'";
$res=mysqli_query($con,$sel);
$n=mysqli_num_rows($res);

 if($n>0)
    {?><h2 class="text-center mt-5">Pending Order Details</h2>
    <?php }?>
<p></p>
<div class="p-5 ">
<table class="table" border="2"> 
  ...
  <tr>
    ...
    <td><a href="approveorder.php?id=<?php echo $row['id'];?>" >APPROVE</a></td></tr>
   <?php
   }
   }
   }
